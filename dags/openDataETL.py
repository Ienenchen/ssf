...
with DAG(
    ...
    def extract(**kwargs):
        ...
        df_all.to_csv('/opt/airflow/logs/df_all.csv')
    ...
    def transform_filter1():
        ...
        df_1.to_csv('/opt/airflow/logs/results/df1_filter.csv')

    def transform_filter2():
        df_all = pd.read_csv('/opt/airflow/logs/df_all.csv')
        df_2 = df_all.loc[df_all['building state'].str.contains(
            '住宅大樓', regex=False)]
        df_2.to_csv('/opt/airflow/logs/results/df2_filter.csv')
    ...
    def transform_filter3():
        ...
        df_3.to_csv('/opt/airflow/logs/results/df3_filter.csv')
    ...
    # extract_task
    start_task >> transform_task_1
    start_task >> transform_task_2
    start_task >> transform_task_3
